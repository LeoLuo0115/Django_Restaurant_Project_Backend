...
def reserve(request):
    ...
    stop_time 大于 startTime
    12：00 > 8：00
    
    // 
    """

    # start_time < endTime 并且 stop_time 大于 startTime
    try:
    ...
    # 查询可预订的桌子
    desk_objs = Desk.objects.exclude(desk_no__in=desk_nos)
    desk_list = []
    ...
    if desk_no_str:
        ...
        # 记录到 预定表
        try:
            booking = Booking(date_time=datetime, start_time=startTime, stop_time=endTime, preferred_payment_method=value,
